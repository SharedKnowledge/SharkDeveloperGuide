...
Two tags are created, one representing Germany, another one for Berlin. The string {\it isPartOf} is defined for this application. It is just an arbitrary string!
...
public class TaxonomySample {
  public static void main(String args[]) throws SharkKBException {
    ...
    // define c# as sub topic of programming languages
    csharp.move(pl);
  }
}
\end{verbatim}
